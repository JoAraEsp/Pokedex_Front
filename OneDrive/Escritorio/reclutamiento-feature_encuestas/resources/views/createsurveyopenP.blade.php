...
<head>
  ...
  <script src="{{ asset('js/arraySaveOpen.js') }}"></script>
  <script src="{{ asset('js/newQuestionOpen.js') }}"></script>
</head>
<body>
   <!-- Encabezado -->
   @include('PrinNav')
  ...
  <form class="form" method="POST" action="{{ route('surveys.storePublicoOpen') }}">
    @csrf
  <div class="tipo-preguntas">
        <label>Tipo de preguntas:</label>
        <label name="tipo-de-pregunta" value="Abiertas">Abiertas</label>
      </div>
      <div class="tipo-encuesta">
        <label>Tipo de encuesta:</label>
        <label name="tipo-de-encuesta">Público</label>
      </div>
      ...
      <div class="form-button">
          <button class="guardar" onclick="mostrarDialogoGuardar()" type="submit">Guardar</button>
